...
_FEW_SHOT_CHECKING_DEPOSIT = (
    ...
    "불이익이 있는 만큼 생활비가 아닌 장기 저축 전용으로 구분했습니다. 원금 손실을 극도로 꺼리고 "
...
_FEW_SHOT_THREE_ACCOUNTS = (
    ...
    "책정했고, 파킹통장에 비상금이 이미 확보돼 있어 이번 달은 예비비만 소액 추가했습니다. 손실 "
    "위험을 감수하더라도 적극적으로 수익을 추구하는 성향이고 저축 여력도 충분해, 투자금은 허용 "
...
_FEW_SHOT_FOUR_PLUS = (
    ...
    "비상금 충전을 가장 먼저 처리했습니다. 남은 여력은 장기 저축과 단기 용돈으로 나눠 계좌별 역할을 "
    "분명히 했고, 안정성과 수익성을 함께 추구하면서 장기적 관점을 가진 성향이라 투자금은 허용 "
    "범위의 중간 수준에서 꾸준히 늘려가는 방향으로 설정했습니다.\""
)
