...
_FEW_SHOT_CHECKING_PARKING = (
    ...
    "상황: 가처분소득 200만원, 변동지출 75만원(식비·교통·여가), 잉여자금 125만원\n"
    ...
    "예시 reasoning: \"식비가 변동지출 중 가장 큰 비중을 차지해 생활비를 다른 항목보다 우선 넉넉히 "
    "확보했고, 파킹통장 잔액이 거의 비어 있어 비상금 충전도 함께 챙겼습니다. 원금 손실 위험은 "
    "크게 지지 않으면서 수익도 일부 추구하려는 성향이라, 투자금은 허용 범위의 하단에 가깝게 "
    "안정성을 우선해 설정했습니다.\""
)

_FEW_SHOT_CHECKING_DEPOSIT = (
    "[참고 예시 — 계좌 2개: 입출금 + 정기예금, PorTI: STABLE(ARCHERY)]\n"
    "상황: 가처분소득 250만원, 변동지출 90만원, 잉여자금 160만원\n"
    "계좌: A입출금통장(CHECKING, 잔액 120만원) / B정기예금(DEPOSIT, 잔액 500만원)\n\n"
    "<STEP 1> 계좌 역할 결정\n"
    "  A입출금통장(CHECKING) → 역할: 생활비  이유: 일상 지출 전담, 수시 입출금 가능\n"
    "  B정기예금(DEPOSIT)   → 역할: 비상금  이유: 중도해지 불이익 있어 생활비 부적합, 장기 비상금 적립 전용\n\n"
    "<STEP 2> invest_amount 결정 — PorTI 허용 범위를 반드시 먼저 확인\n"
    ...
    "  · 나머지 115만원 전액 정기예금 비상금 장기 적립\n\n"
    "예시 결과: invest_amount=250,000 / CHECKING 생활비 1,100,000원 / DEPOSIT 비상금 1,150,000원\n"
    "합계 확인: 250,000 + 1,100,000 + 1,150,000 = 2,500,000원 ✓\n\n"
    "예시 reasoning: \"매달 변동지출 규모를 그대로 반영해 생활비를 책정했고, 정기예금은 중도해지 "
    "불이익이 있는 만큼 생활비 대신 비상금 장기 적립용으로 구분했습니다. 원금 손실을 극도로 꺼리고 "
    "장기적으로 자산을 불려가려는 성향이라, 투자금은 허용 범위 중에서도 가장 낮은 수준으로 "
    "보수적으로 설정했습니다.\""
)

_FEW_SHOT_THREE_ACCOUNTS = (
    "[참고 예시 — 계좌 3개: 입출금 + 파킹 + 정기예금, PorTI: INVEST(CYCLING)]\n"
    "상황: 가처분소득 300만원, 변동지출 110만원(식비·교통·쇼핑 등), 잉여자금 190만원\n"
    ...
    "  C정기예금(DEPOSIT)→ 역할: 비상금  이유: 장기 비상금 적립 전용, 매달 꾸준히 적립\n\n"
    "<STEP 2> invest_amount 결정 — PorTI 허용 범위를 반드시 먼저 확인\n"
    "  · PorTI INVEST(CYCLING) 허용 범위: 300만원 x 25~50% = 750,000원~1,500,000원\n"
    "  · 적극적 수익 추구 성향, 여유 자금 충분 → 범위 내 적극적 설정\n"
    ...
    "  · 나머지 40만원 → 정기예금 비상금 장기 적립\n\n"
    "예시 결과: invest_amount=900,000 / CHECKING 생활비 1,200,000원 / PARKING 예비비 500,000원 / DEPOSIT 비상금 400,000원\n"
    "합계 확인: 900,000 + 1,200,000 + 500,000 + 400,000 = 3,000,000원 ✓\n\n"
    "예시 reasoning: \"식비·교통·쇼핑 지출이 고르게 분산돼 있어 변동지출 전체 규모만큼 생활비를 "
    "책정했고, 파킹통장에 예비비를 소액 추가하고 정기예금에 비상금을 장기 적립했습니다. 손실 "
    "위험을 감수하더라도 적극적으로 수익을 추구하는 성향이고 여유 자금도 충분해, 투자금은 허용 "
    "범위 중에서도 상단에 가깝게 설정했습니다.\""
)

_FEW_SHOT_FOUR_PLUS = (
    "[참고 예시 — 계좌 4개 이상, PorTI: NEUTRAL(RHYTHMIC)]\n"
    "상황: 가처분소득 350만원, 변동지출 130만원, 잉여자금 220만원\n"
    ...
    "  C정기예금(DEPOSIT)→ 역할: 비상금  이유: 장기 비상금 적립 전용\n"
    "  D CMA(CMA)       → 역할: 용돈(취미)  이유: 단기 유동성 자금, 취미·여가 예비비\n\n"
    "<STEP 2> invest_amount 결정 — PorTI 허용 범위를 반드시 먼저 확인\n"
    "  · PorTI NEUTRAL(RHYTHMIC) 허용 범위: 350만원 x 15~35% = 525,000원~1,225,000원\n"
    "  · 균형 투자 성향, 여유 자금 충분 → 범위 중간 설정\n"
    ...
    "  · 나머지를 정기예금 비상금(35만원)·용돈(취미)(10만원)으로 분산, 금액이 작아도 역할이 다르면 배분\n\n"
    "예시 결과: invest_amount=700,000 / CHECKING 생활비 1,350,000원 / PARKING 비상금 1,000,000원 / DEPOSIT 비상금 350,000원 / CMA 용돈(취미) 100,000원\n"
    "합계 확인: 700,000 + 1,350,000 + 1,000,000 + 350,000 + 100,000 = 3,500,000원 ✓\n\n"
    "예시 reasoning: \"변동지출 규모를 그대로 반영해 생활비를 책정했고, 파킹통장 잔액이 비어 있어 "
    "비상금 충전을 가장 먼저 처리했습니다. 정기예금에 비상금을 장기 적립하고 CMA에 취미 용돈을 "
    "소액 배분해 계좌별 역할을 분명히 했으며, 안정성과 수익성을 함께 추구하는 성향이라 투자금은 허용 "
    "범위의 중간 수준으로 설정했습니다.\""
)
...
class _AllocationItem(BaseModel):
    ...
    account_purpose: Literal["생활비", "비상금", "예비비", "용돈(취미)"] = Field(
        default="비상금", description="배분 용도 — 투자 관련 용어 사용 불가"
    )
...
class _RebalancePlan(BaseModel):
    ...
    reasoning: str = Field(
        ...
        description=(
            ...
            "반드시 아래 3가지를 포함해 2~3문장으로 정리:\n"
            "① 소비 패턴 — 어떤 카테고리 지출이 가장 크거나 특징적인지 구체적으로 언급\n"
            "② 계좌 상태/역할 — 어떤 계좌의 잔액 상태(많음·적음·없음)가 배분 우선순위에 영향을 줬는지\n"
            "③ 투자 성향 — 위험 감수 정도를 구체적으로 서술하고, 그 결과 투자금이 허용 범위의 "
            "하단·중간·상단 중 어디에 위치하는지 연결\n"
...
_SYSTEM = (
    ...
    "2. 비상금 — 월급의 3~6배를 목표로 배분 (DEPOSIT 또는 PARKING)\n"
    "3. 예비비 — 월급의 10% 정도를 예비비 명목으로 PARKING 또는 CMA에 배분\n"
    "4. 용돈(취미) — 소비 패턴을 보고 취미·여가 영역 있으면 별도 배분\n\n"
    ...
    "   반드시 ① 가장 크거나 특징적인 소비 카테고리 ② 배분 우선순위에 영향을 준 계좌 잔액 상태 "
    "③ 위험 감수 정도와 그에 따라 투자금이 허용 범위의 하단·중간·상단 중 어디에 위치하는지, "
    "이 3가지를 모두 담을 것\n\n"
    "출력 규칙:\n"
...
_REFLECT_SYSTEM = (
    ...
    "  - 계좌 용도와 comment가 명백히 불일치하는 경우 (예: comment에 '비상금'이라 쓰여 있는데 account_purpose가 '예비비')\n"
    "  - DEPOSIT 계좌가 있는데 비상금 관련 배분이 전혀 없는 경우 (DEPOSIT 계좌 미활용)\n"
    ...
    "  → feedback: 'CHECKING에 생활비 배분 외에 PARKING 또는 DEPOSIT에도 비상금/예비비 배분 추가'\n\n"
    "예시 C: 계좌 4개, 배분 2개\n"
    ...
    "예시 F: PARKING 계좌 — account_purpose='예비비', comment='비상금이 3만원뿐이라 우선 채워드렸어요'\n"
    "  → approved=False  이유: comment는 '비상금 충전'을 설명하는데 account_purpose='예비비'로 내용이 불일치\n"
